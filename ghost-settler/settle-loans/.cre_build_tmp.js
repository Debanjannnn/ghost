...
var require_consts = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.AEAD_TAG_LENGTH = exports.XCHACHA20_NONCE_LENGTH = exports.CURVE25519_PUBLIC_KEY_SIZE = exports.ETH_PUBLIC_KEY_SIZE = exports.UNCOMPRESSED_PUBLIC_KEY_SIZE = exports.COMPRESSED_PUBLIC_KEY_SIZE = exports.SECRET_KEY_LENGTH = undefined;
...
var require_config = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.ephemeralKeySize = exports.symmetricNonceLength = exports.symmetricAlgorithm = exports.isHkdfKeyCompressed = exports.isEphemeralKeyCompressed = exports.ellipticCurve = exports.ECIES_CONFIG = exports.Config = undefined;
...
var require_webcrypto = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.gcm = exports.ctr = exports.cbc = exports.utils = undefined;
  ...
  class SHA256 extends _md_ts_1.HashMD {
    ...
    process(view, offset) {
      ...
      for (let i2 = 0;i2 < 64; i2++) {
        ...
        const T1 = H + sigma1 + (0, _md_ts_1.Chi)(E2, F, G) + SHA256_K[i2] + SHA256_W[i2] | 0;
...
var require_utils3 = __commonJS((exports) => {
  ...
  function _abytes2(value2, length, title = "") {
    const bytes = (0, utils_js_1.isBytes)(value2);
  ...
  function numberToBytesBE(n, len2) {
    return (0, utils_js_1.hexToBytes)(n.toString(16).padStart(len2 * 2, "0"));
  }
  ...
  function tonelliShanks(P) {
    ...
    return function tonelliSlow(Fp, n) {
      ...
      while (!Fp.eql(t, Fp.ONE)) {
        ...
        const exponent = _1n << BigInt(M - i2 - 1);
...
var require_edwards = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.PrimeEdwardsPoint = undefined;
  ...
  function edwards(params, extraOpts = {}) {
    ...
    class Point {
      ...
      static fromBytes(bytes, zip215 = false) {
        const len2 = Fp.BYTES;
        const { a, d } = CURVE;
        bytes = (0, utils_ts_1.copyBytes)((0, utils_ts_1._abytes2)(bytes, len2, "point"));
        (0, utils_ts_1._abool2)(zip215, "zip215");
        const normed = (0, utils_ts_1.copyBytes)(bytes);
        const lastByte = bytes[len2 - 1];
  ...
  function eddsa(Point, cHash, eddsaOpts = {}) {
    ...
    function verify(sig, msg, publicKey, options = verifyOpts) {
      ...
      const len2 = lengths.signature;
      sig = (0, utils_ts_1.ensureBytes)("signature", sig, len2);
      msg = (0, utils_ts_1.ensureBytes)("message", msg);
      ...
      const s = (0, utils_ts_1.bytesToNumberLE)(sig.subarray(mid, len2));
      let A, R, SB;
      try {
...
var require_hash_to_curve = __commonJS((exports) => {
  ...
  function expand_message_xmd(msg, DST, lenInBytes, H) {
    ...
    for (let i2 = 1;i2 <= ell; i2++) {
      ...
      b[i2] = H((0, utils_ts_1.concatBytes)(...args));
    }
...
var require__shortw_utils = __commonJS((exports) => {
  ...
  function createCurve(curveDef, defHash) {
    const create3 = (hash) => (0, weierstrass_ts_1.weierstrass)({ ...curveDef, hash });
...
var require__polyval = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.polyval = exports.ghash = undefined;
...
var require_aes = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.unsafe = exports.aeskwp = exports.aeskw = exports.siv = exports.gcmsiv = exports.gcm = exports.cfb = exports.cbc = exports.ecb = exports.ctr = undefined;
  var _polyval_ts_1 = require__polyval();
  var utils_ts_1 = require_utils();
  var BLOCK_SIZE = 16;
  var BLOCK_SIZE32 = 4;
  ...
  var limit = (name, min, max) => (value2) => {
    if (!Number.isSafeInteger(value2) || min > value2 || value2 > max) {
      const minmax = "[" + min + ".." + max + "]";
      throw new Error("" + name + ": expected value in range " + minmax + ", got " + value2);
    }
  };
  ...
  exports.aeskwp = (0, utils_ts_1.wrapCipher)({ blockSize: 8 }, (kek) => ({
    ...
    decrypt(ciphertext) {
      ...
      const o32 = (0, utils_ts_1.u32)(out);
      AESW.decrypt(kek, out);
      const len2 = byteSwap(o32[1]) >>> 0;
      const padded = Math.ceil(len2 / 8) * 8;
      if (o32[0] !== AESKWP_IV || out.length - 8 !== padded)
        throw new Error("integrity check failed");
      for (let i2 = len2;i2 < padded; i2++)
        if (out[8 + i2] !== 0)
          throw new Error("integrity check failed");
      out.subarray(0, 8).fill(0);
      return out.subarray(8, 8 + len2);
    }
  }));
  exports.unsafe = {
    expandKeyLE,
...
var require_noble = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.aes256cbc = exports.aes256gcm = undefined;
...
var require__arx = __commonJS((exports) => {
  ...
  function createCipher(core, opts) {
    ...
    return (key, nonce, data, output, counter = 0) => {
      ...
      const len2 = data.length;
      if (output === undefined)
        output = new Uint8Array(len2);
      (0, utils_ts_1.abytes)(output);
      (0, utils_ts_1.anumber)(counter);
      if (counter < 0 || counter >= MAX_COUNTER)
        throw new Error("arx: counter overflow");
      if (output.length < len2)
        throw new Error(`arx: output (${output.length}) is shorter than data (${len2})`);
      const toClean = [];
      let l = key.length;
      let k;
      let sigma;
...
var require_noble2 = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
...
function decryptRate(encryptedRate, privateKeyHex) {
  ...
  if (privateKeyHex) {
    try {
      ...
      const decrypted = import_eciesjs.decrypt(privateKeyHex, encrypted);
...
function runMatchingEngine(lendIntents, borrowIntents, privateKeyHex) {
  ...
  for (const l of lends)
    remaining.set(l.intentId, l.amount);
  const proposals = [];
  for (const borrow of borrows) {
    ...
    for (const lend of lends) {
      if (filled >= borrow.amount)
        break;
      if (lend.token !== borrow.token)
        continue;
...
var API_KEY_SECRET = [{ key: "INTERNAL_API_KEY", namespace: "ghost-protocol" }];
var onCronTrigger = (runtime2, _payload) => {
  runtime2.log("settle-loans triggered");
  const confClient = new cre.capabilities.ConfidentialHTTPClient;
  const base = runtime2.config.ghostApiUrl;
  let crePrivateKey;
  try {
    crePrivateKey = runtime2.getSecret({ id: "CRE_PRIVATE_KEY" }).result().value;
  } catch (_) {
    runtime2.log("CRE_PRIVATE_KEY not available, using plaintext/default rates");
  }
  confClient.sendRequest(runtime2, {
  ...
  const getResp = confClient.sendRequest(runtime2, {
    vaultDonSecrets: API_KEY_SECRET,
    request: {
  ...
  if (!ok(postResp))
    return "error:record-proposals";
  const postData = json(postResp);
  const result = "matched:" + proposals.length + " recorded:" + (postData.recorded ?? 0);
  runtime2.log("settle-loans result: " + result);
  return result;
};
